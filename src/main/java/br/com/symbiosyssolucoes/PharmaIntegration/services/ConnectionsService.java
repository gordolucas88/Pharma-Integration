...
public class ConnectionsService {
    ...
    private Optional<List<Connections>> listConnectionsByOrigin(ConnectionsTypes connectionsTypes){

        Optional<List<Connections>> connections = Optional.ofNullable(this.connectionsRepository.findByOriginEqual(connectionsTypes));
